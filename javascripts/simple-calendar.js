    ...
    _createClass(SimpleCalendar, [{
        ...
        value: function create() {
            ...
            header.innerHTML += '<div class="sc-actions" style="min-width: 230px !important;">'
                ...
                + '      <select disabled class="sc-select-year" name="">' + '      </select>'
                + '      <div class="sc-yright">&rsaquo;</div>' + '    <div class="sc-mleft">'
                + '      &lsaquo;</div>' + '    <select disabled class="sc-select-month" name="">'
        ...
        key: 'updateAndDoNotCallMain',
        value: function updateAndNotCallMain() {
            ...
            this.addData(year, month);
            this.updateHoliday(year, month);
            this.updateMark(year, month, true);
            this.updateFestival(year, month);
            this.updateEvent();
            this.updateTheme(this._options.theme);
        }
        ...
        key: 'updateMark',
        value: function updateMark(year, month, doNotCallMain) {
            var options = this._options;
            if (options.showMark) {
                var daysElement = this.arrayfrom(this.container.querySelectorAll('.sc-item'));
                var currentmonth = month - 1;
                //@-初始化数据：
                if (this._options.main && !doNotCallMain) options.mark = this._options.main(year, month);
                this._options.sp = [];
        ...
        key: 'addMark',
        value: function addMark(resultObj) {
            this._options.mark = resultObj;
            this.updateAndDoNotCallMain();
        }
